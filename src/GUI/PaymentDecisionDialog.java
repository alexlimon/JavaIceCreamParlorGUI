...
public class PaymentDecisionDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form PaymentDecisionDialog
     */
    public PaymentDecisionDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
  ...
  public void setShopeditor(Shop shopeditor) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentDecisionDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PaymentDecisionDialog dialog = new PaymentDecisionDialog(new javax.swing.JFrame(), true);
